...
// 获取用户补充信息
export const fetchGetDetailInfo = (params: any) => (dispatch: any) => {
...
// 用户注册
export const fetchReduxRegist = (data: any, fn?: any) => (dispatch: any) => {
...
// 用户登录
export const fetchReduxLogin = (data: any, fn?: any) => (dispatch: any) => {
...
// 用户退出登录
export const fetchReduxLogout = (data: any, fn?: any) => (dispatch: any) => {
...
// 用户更新详细信息
export const updateReduxDetailInfo = (payload: any) => (dispatch: any) => {
  dispatch({
...
// 用户更新登录信息
export const updateReduxUserInfo = (payload: any) => (dispatch: any) => {
  dispatch({
    type: UPDATEUSERINFO,
    payload,
  });
